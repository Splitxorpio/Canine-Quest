(function() { // private module pattern
  ...
  var FPS           = 60,                                                   // 'update' frame rate fixed at 60fps independent of rendering loop
      ...
      IMAGES        = ['ground', 'ladder', 'player', 'monster', 'coins', 'portal'],   // sprite image files for loading
  ...
  var Player = Class.create({
    ...
    collectCoin: function(point) {
      ...
      if (this.score == 3000){
        alert("Something has opened! Its a portal!");
        window.location.assign("../cutscene.html");
      }
    },
  ...
  var Renderer = Class.create({
    ...
    /*renderPortal: function(ctx) function(ctx) {
      
      var portal = this.images.portal;
